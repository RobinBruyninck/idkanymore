    ...
    >
      <section className="mx-auto w-full max-w-[1400px]">
  	  ...
  	  <nav className="relative z-30 mt-8 grid grid-cols-2 gap-2 text-[11px] font-semibold uppercase leading-none tracking-[0.03em] md:absolute md:bottom-4 md:left-4 md:mt-0 md:flex md:flex-col md:gap-y-1 md:text-[12px] md:tracking-normal">
  	    <Link href="/" className="flex min-h-10 items-center justify-center border border-[#f2f2ee]/20 px-2 py-2 hover:text-[#f2f2ee] md:min-h-0 md:justify-start md:border-0 md:px-0 md:py-0">
          Home
        </Link>
  	    <Link href="/projects" className="flex min-h-10 items-center justify-center border border-[#f2f2ee]/20 px-2 py-2 hover:text-[#f2f2ee] md:min-h-0 md:justify-start md:border-0 md:px-0 md:py-0">
          Projects
        </Link>
  	    <Link href="/about" className="flex min-h-10 items-center justify-center border border-[#f2f2ee]/20 px-2 py-2 hover:text-[#f2f2ee] md:min-h-0 md:justify-start md:border-0 md:px-0 md:py-0">
          About
        </Link>
        <a
          ...
          rel="noopener noreferrer"
  	          className="flex min-h-10 items-center justify-center border border-[#f2f2ee]/20 px-2 py-2 hover:text-[#f2f2ee] md:min-h-0 md:justify-start md:border-0 md:px-0 md:py-0"
        >
          LinkedIn
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
  	          className="col-span-2 flex min-h-10 items-center justify-center border border-[#f2f2ee]/20 px-2 py-2 hover:text-[#f2f2ee] md:col-span-1 md:min-h-0 md:justify-start md:border-0 md:px-0 md:py-0"
        >
          Instagram
        </a>
      </nav>
