  ...
  return (
    ...
    >
      <section className="mx-auto w-full max-w-[1400px]">
  	  ...
  	  <nav className="relative z-30 mt-8 flex flex-wrap gap-x-4 gap-y-2 text-[13px] font-bold uppercase leading-[1] md:absolute md:bottom-4 md:left-4 md:mt-0 md:flex-col md:gap-y-1 md:text-[12px]">
