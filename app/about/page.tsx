  ...
  return (
    ...
    >
      ...
      <nav className="relative z-30 mt-8 grid grid-cols-2 gap-2 text-[11px] font-bold uppercase leading-none tracking-[-0.01em] md:absolute md:bottom-4 md:left-4 md:mt-0 md:flex md:flex-col md:gap-y-1 md:text-[12px] md:tracking-normal">
        <Link href="/" className="flex min-h-10 items-center justify-center border border-black px-2 md:min-h-0 md:justify-start md:border-0 md:px-0">
          Home
        </Link>
        <Link href="/projects" className="flex min-h-10 items-center justify-center border border-black px-2 md:min-h-0 md:justify-start md:border-0 md:px-0">
          Projects
        </Link>
        <Link href="/contact" className="flex min-h-10 items-center justify-center border border-black px-2 md:min-h-0 md:justify-start md:border-0 md:px-0">
          Contact
        </Link>
        <a
          ...
          className="flex min-h-10 items-center justify-center border border-black px-2 md:min-h-0 md:justify-start md:border-0 md:px-0"
        >
          LinkedIn
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="col-span-2 flex min-h-10 items-center justify-center border border-black px-2 text-[12px] md:col-span-1 md:min-h-0 md:justify-start md:border-0 md:px-0 md:text-[12px]"
        >
          Instagram
        </a>
      </nav>
